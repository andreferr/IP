    ...
    public static void main (String[] args) {
        ...
        if (alvopontos.length>=1) {
            ...
            for (int i = 0; i < kunais; i++) {
                sasukeacerto[i] = Integer.parseInt(in.next());
                if (sasukeacerto[i] == 0) {
                } else if (sasukeacerto[i] <= alvopontos.length) {
                    sasukeacerto[i]-=1;
                    for (int j=0;j<i && sasukeacerto[i] != 0;j++) {
                        if (sasukeacerto[i]==sasukeacerto[j]) {
                            sasukeacerto[i] = 0;
                            sasukepontos-=1;
                        }
                    }
            ...
            for (int i = 0; i < kunais; i++) {
                itachiacerto[i] = Integer.parseInt(in.next());
                if (itachiacerto[i] == 0) {
                } else if (itachiacerto[i] <= alvopontos.length) {
                    itachiacerto[i]-=1;
                    for (int j=0;j<i && itachiacerto[i] != 0;j++) {
                        if (itachiacerto[i]==itachiacerto[j]) {
                            itachiacerto[i] = 0;
                            itachipontos-=1;
                        }
                    }
